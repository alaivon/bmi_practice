		  ...
		  when 4
			...
			when 5
				...
				for i in 0..hsinchusan.size do
					@country = Distance.new
					@country.dist_name = hsinchusan[i]
					@country.city_id = 7
					@country.save
				end
